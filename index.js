...
// ANSWER: you can change it to be if numbers[i] === 4 and cut out count entirely.
...
// ANSWER: You can make thid into a linear if you take out the numbers2 and just square the numbers or multiply it by itself.
...
// ANSWER: because at the end of the day they bothhave the same end points and using a for loop to get through them.
